...
l1 = Label(
    root,
    text="CLICK THE BUTTONS TO PERFORM THE FUNCTIONALITIES MENTIONED",
    fg="white",
    bg="purple",
    width=98,
    borderwidth=5,
...
btn9 = Button(
    ...
    fg="white",
    bg="purple",
    command=powerlawtrans,
)
btn9.grid(row=10, column=0, padx=10, pady=10, sticky="nesw")

btn10 = Button(
    root, text="CONTRAST ENHANCEMENT", fg="white", bg="purple", command=histo
)
...
btn15 = Button(
    root, text="COLOR PENCIL SKETCH", fg="white", bg="purple", command=colpencil
)
